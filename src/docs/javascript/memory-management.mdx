...
When this code executes, JS Engine will...
...
![memory stack example](https://felixgerschau.com/static/b94165593eb6e02d73039d8b2cfccfdd/29007/stack-memory-explained.png)
