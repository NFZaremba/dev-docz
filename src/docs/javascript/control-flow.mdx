...
- Syntax:
  - **expr1** && **expr2**
- Description:
  - If **expr1** evaluates to `true`, returns **expr2**. <br /> Else it short-circuits and returns **expr1** if `falsey`.
...
- Syntax:
  - **expr1** || **expr2**
- Description:
  - If **expr1** evaluates to `true`, returns **expr1**. <br /> Else it short-circuits and returns **expr2** if `falsey`. (**think of it as a fallback!**)
- Short-circuit evaluation:
...
- [Type Coercion](https://javascript.plainenglish.io/implicit-type-coercion-in-javascript-7eb6170a2d87)
- [Reddit explanation](https://www.reddit.com/r/learnprogramming/comments/7w5fw7/javascript_concept_what_is_type_coercion/)
